Rails.application.configure do
  ...
  config.assets.precompile += %w( *.png *.gif *.jpg admin.css admin.js AdminLTE/app.js )
  ...
  if ENV['system_email'].present?
    config.middleware.use ExceptionNotification::Rack,
      email: {
        email_prefix: "[#{Const::PRODUCT} Exception] ",
        sender_address: ENV['email'],
        exception_recipients: ENV['system_email'].split(',')
    }
  end
